...
export function buildSystemPrompt(input: AdapterInput): string {
  const base =
    ...
    "then respond with the complete, final issue list as JSON matching the provided schema. " +
    "Character offsets (start/end) must be relative to the original text.";
